...
import com.Pratice.HeapDes.HeapDes;
...
public class Main {
    ...
    public static List<Integer> streamMax(int []num){
        HeapDes heap=new HeapDes();
          int biggest=0;
        ...
        else if(num[biggest]<num[i]){
                heap.insert(num[i]);
                biggest=i;
            }
        
        else{
                heap.insert(num[biggest]);
            }
        }
